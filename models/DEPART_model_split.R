...
## "Split" version applied to US-VCP data and coded to account for large gap
## in measurements.
...
model{
  ...
  # Priors for "initial conditions" for WUE. Accounts for large gap in data,
  # by defining WUE.pred separately before and after the large gap.
