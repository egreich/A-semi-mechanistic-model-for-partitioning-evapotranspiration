...
## 1. Request Parameters  
    ...
    Date Completed:** 2021-03-31T05:46:25.706738  

    Id: 223fdd3b-6da5-4091-80b7-5c2bd3552825  
    ...
    Details:  
        ...
        Layers:  
            ...
            Water_Use_Efficiency_WUEavg (ECO4WUE.001)  
    
        Coordinates:  

            US-Ses, NMEG, 34.3349, -106.7442  
            US-Seg, NMEG, 34.3623, -106.702  
            US-Wjs, NMEG, 34.4255, -105.8615  
            US-Mpj, NMEG, 34.4385, -106.2377  
            US-Vcp, NMEG, 35.8642, -106.5967  
            US-Vcm, NMEG, 35.8884, -106.5321  
            US-Vcp, NMEG, 35.9193, -106.6142  
    
    Version: This request was processed by AppEEARS version 2.57  

## 2. Request File Listing  

- Comma-separated values file with data extracted for a specific product
  - NMEG-WUE-ECO4WUE-001-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - NMEG-WUE-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - NMEG-WUE-request.json
- xml file
  - NMEG-WUE-ECO4WUE-001-metadata.xml  
...
- Hook, S., Fisher, J. (2019). ECOSTRESS Water Use Efficiency Daily L4 Global 70 m V001. NASA EOSDIS Land Processes DAAC. Accessed 2021-03-31 from https://doi.org/10.5067/ECOSTRESS/ECO4WUE.001. Accessed March 31, 2021.

## 9. Software Citation  

AppEEARS Team. (2020). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.57. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed March 31, 2021. https://lpdaacsvc.cr.usgs.gov/appeears
