# A semi-mechanistic model for partitioning evapotranspiration reveals supply and demand moisture controls over plant water-use efficiency are temporally distinct
