...
ETpart <- function(dataIN, dataIN_wue, dataIN_gpp, zcfilename, sumfilename, quanfilename, key = NULL){
  ...
  zc1 = coda.samples(jm1.b,variable.names=c("ET", "E.model", "ET.pred", "ET.rep", "T.pred", "T.ratio", #"S.corr",
                                            ...
                                            'bch.pred', "c1", "c2", "deviance", 'fc.pred', 'k.pred', "p", 'psisat.pred', "sig.ET","sig.WUE", "sig.ecostress", "slope", 'ssat.pred', 'sres.pred', "tau.ecostress", 'vk.pred'),
